...
import com.gestion.mascotas.logica.NormalizacionDatos;
...
public class PerfilServlet extends HttpServlet {
    ...
    private void actualizarPerfil(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            nombre = NormalizadorDatos.normalizarNombre(nombre);
            email = NormalizadorDatos.normalizarEmail(email);
            telefono = NormalizadorDatos.normalizarTelefono(telefono);
