...
class AnalizadorDatosTest {
    ...
    // --- CAMBIO 2: Añadir Mocks para los DAOs ---
    @Mock
    private SugerenciaAlimentacionDAO sugerenciaAlimentacionDAOMock;
    @Mock
    private SugerenciaEjercicioDAO sugerenciaEjercicioDAOMock;
    ...
    void setUp() {
        ...
        // 2. Usar el NUEVO constructor con los mocks
        analizador = new AnalizadorDatos(sugerenciaAlimentacionDAOMock, sugerenciaEjercicioDAOMock);

        // 3. BORRAR la línea antigua:
        // analizador = new AnalizadorDatos();

        // Configurar usuario de prueba (esto queda igual)
        usuarioTest = new Usuario();
        usuarioTest.setId(1L);
        usuarioTest.setNombreUsuario("testUser");

        // Configurar mascota perro (esto queda igual)
        ...
        // Configurar mascota gato (esto queda igual)
